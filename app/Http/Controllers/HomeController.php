...
class HomeController extends Controller
{
    ...
    public function reenviar(){
        ...
        $usuario->save();
         ...
         return redirect('/home')->with('info','Mensaje enviado a su telefono');
         }catch(\Throwable $th){
            return back()->with('error','No se pudo enviar el mesaje. INTENTALO DE NUEVO');
         }
    }
}
